...
type User struct {
	...
	DeletedAt soft_delete.DeletedAt `gorm:"column:delete_time;not null;uniqueIndex:udx_username;uniqueIndex:udx_email;comment:删除时间"`
}

// ToSchema converts user model to user schema.
